...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    //mapping of tokenId's to token uri's called '_tokenURIs'
    ...
    function setTokenURI(uint256 tokenId) internal {
        ...
        string memory tokenURIStr = strConcat(this.baseTokenURI(), uint2str(tokenId));
        _tokenURIs[tokenId] = tokenURIStr;
    }

}

contract RealEstateERC721Token is ERC721Metadata("RealEstate", "REM", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/")
{
